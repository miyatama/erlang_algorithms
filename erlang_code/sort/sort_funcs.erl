...
sort_test(F) ->
  ...
  show_check_result("sort_test - case 0010 enjoy text book: ~w", L10TestResult, L10, L10Expect, L10SortResult),
  ok.
...
show_check_result(Title, true, _, _, _) ->
  ?INFO(Title, [true]);
show_check_result(Title, false, Source, Expect, Result) ->
  ?INFO(Title, [false]),
